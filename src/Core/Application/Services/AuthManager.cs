...
public class AuthManager : IAuthService
{
    ...
    public async Task RevokeRefreshTokens(ICollection<RefreshToken> tokens)
    {
    ...
    {
        return await _refreshTokenRepository.UpdateRefreshTokenTransaction(newRefreshToken);
    }
}
